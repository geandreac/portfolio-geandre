...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 dark:bg-[#121212] dark:text-gray-100 font-sans transition-colors duration-300">
  ...
  <div className="max-w-6xl mx-auto px-6 flex flex-col items-center">
    <div className="flex gap-6 mb-8">
      <a href="https://github.com/geandreac" target="_blank" className="p-3 bg-gray-100 dark:bg-[#1a1a1a] rounded-full hover:text-primary transition-all">
      ...
      <a href="https://www.linkedin.com/in/geandreac/" target="_blank" className="p-3 bg-gray-100 dark:bg-[#1a1a1a] rounded-full hover:text-primary transition-all">
      ...
      <a href="https://wa.me/5592992610077" target="_blank" className="p-3 bg-gray-100 dark:bg-[#1a1a1a] rounded-full hover:text-primary transition-all">
