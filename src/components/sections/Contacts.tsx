...
export const Contacts: React.FC = () => {
  return (
    <section id="contacts" className="py-20 px-6 lg:px-12 mx-auto max-w-[960px]">
      <SectionHeading id="contacts" title="contact" />
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[1px] bg-border border border-border mb-12">
        <div className="bg-bg p-6">
          <h4 className="text-xs font-bold text-text mb-4 pb-2 border-b border-white/5 uppercase tracking-widest opacity-80">Mensagem direta</h4>
        ...
        <div className="bg-bg p-6">
          <h4 className="text-xs font-bold text-text mb-4 pb-2 border-b border-white/5 uppercase tracking-widest opacity-80">Redes profissionais</h4>
          <div className="space-y-4">
             <a 
