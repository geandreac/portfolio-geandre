      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6 text-center md:text-left order-2 md:order-1">
          ...
          <div className="flex flex-wrap gap-6 justify-center md:justify-start py-2">
            ...
            <a href="https://wa.me/5592992610077" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sm font-bold text-gray-600 dark:text-gray-400 hover:text-green-500 transition-colors group">
