  ...
  return (
    <footer className="bg-bg3 border-t border-white/5 mt-24">
      <div className="max-w-[960px] mx-auto px-8 py-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          <div className="flex items-center gap-3 text-text font-bold text-sm mb-3">
        ...
        <div className="md:text-right">
          ...
          <div className="flex gap-6 md:justify-end">
            <a 
              ...
              className="text-muted hover:text-purple transition-all duration-300 hover:-translate-y-1"
            >
